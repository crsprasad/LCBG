...
public enum PaymentStatusEnum {
	...
	REJECTED_O ("Rejected", "23"),//Rejected at QNG (A response might have been sent already) - Actions - Re-Process
	...
	COMPLETED_I("Completed", "45"), //POSSIBLE_ACTIONS: None
	RETURNED_I("Returned","46"), //Return Status for InBound Payments
	DUPLICATES_I("Duplicate","47"), //Duplicate status for Inbound Payments
	REJECTED_I ("Rejected","48"); //Rejected at QNG (a response to the host or payment channel has been sent) - No Action only view
	...
	/**
	 * This method return the Enum description by passing enum code
	 * @param statusCode
	 * @return
	 */
	public static String findPaymentStatusDescriptionByCode(String statusCode)
	{		
		for(PaymentStatusEnum oneEnumSample :PaymentStatusEnum.values())
		{
			if(oneEnumSample.code.equalsIgnoreCase(statusCode))
				return oneEnumSample.paymentStatusDesc;
